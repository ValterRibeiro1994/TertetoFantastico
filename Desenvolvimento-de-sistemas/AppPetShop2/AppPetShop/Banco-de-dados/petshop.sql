...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 22/06/2026 às 03:21
...
INSERT INTO `tb_consulta` (`id_consulta`, `cod_pet`, `data_consulta`, `prescricao_consulta`) VALUES
(1, 1, '2026-06-01', 'Cachorro com excesso de gostosura igual o tutor'),
(2, 2, '2019-11-24', 'Sacrificado'),
(3, 3, '2024-08-23', 'Excesso de velhice, ronca demais, cataratas, dedao direito menor');
...
(1, '07845179913', '2025-10-13', 'M', 'vira-lata', NULL, 'caramelo', 'cachorro'),
(2, '56123460854', '2024-02-21', 'M', 'yorkshire', NULL, 'paçoca', 'cachorro'),
(3, '58225745906', '2015-07-30', 'F', 'poddle', NULL, 'veinha', 'cachorro');
...
INSERT INTO `tb_servicos` (`id_servico`, `cod_pet`, `tipo_servico`, `data_servico`, `valor_servico`) VALUES
(1, 1, 'banho', '2026-06-01', 20.50),
(2, 2, 'tosa', '2025-05-31', 54.99),
(3, 3, 'banho', '2026-01-25', 115.70);
